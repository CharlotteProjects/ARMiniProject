...
Shader "Outlined/UltimateOutline"
{
	Properties
	{
		...
		_depthFogHeight("Depth Fog Height", float) = 17.5
		_depthFogBaseLight("Depth Fog Base Light", Range(0, 1)) = 0.5
	...
	uniform float _depthFogHeight;
	uniform float _depthFogBaseLight;
	...
	SubShader{
		...
		void surf(Input IN, inout SurfaceOutput  o) {
			...
			o.Albedo = c.rgb * ((IN.worldPos.y / _depthFogHeight) * (1- _depthFogBaseLight) + _depthFogBaseLight);
			o.Alpha = c.a;
		}
		ENDCG
	}
